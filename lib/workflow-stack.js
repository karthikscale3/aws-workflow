...
class WorkflowStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        this.workerFunction = new lambda.Function(this, "WorkflowWorker", {
            ...
            reservedConcurrentExecutions: props.environment === "dev" ? 10 : undefined,
        });
        // Add SQS event sources to Lambda
        this.workerFunction.addEventSource(new aws_lambda_event_sources_1.SqsEventSource(this.workflowQueue, {
            batchSize: 10,
            maxBatchingWindow: cdk.Duration.seconds(5),
            reportBatchItemFailures: true,
        }));
        this.workerFunction.addEventSource(new aws_lambda_event_sources_1.SqsEventSource(this.stepQueue, {
            batchSize: 10,
            maxBatchingWindow: cdk.Duration.seconds(5),
            reportBatchItemFailures: true,
        }));
