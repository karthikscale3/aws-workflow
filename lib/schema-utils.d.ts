 ...
 */
export declare function getDynamoDBAttributeType(_fieldType: string): dynamodb.AttributeType;
/**
 * Validate that a JavaScript object matches the schema
 */
export declare function validateAgainstSchema<T>(tableName: keyof typeof TableSchemas, data: unknown): T;
/**
 * Get the required attributes for a table based on the schema
 */
export declare function getRequiredAttributes(tableName: keyof typeof TableSchemas): string[];
/**
